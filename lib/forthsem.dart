...
class forthsem extends StatelessWidget {
  const forthsem({Key? key}) : super(key: key);
                ...
                child: Container(
                  child: Row(
                    ...
                    children: [
                      ...
                      Text("  CS WORKSHOP-II",style: TextStyle(color:Colors.white,fontSize: 20),),
                    ],
                  ),
                  height: 50,
                ...
                child: Container(
                  child: Row(
                    ...
                    children: [
                      ...
                      Text("  COMPUTER ARCHITECTURE",style: TextStyle(color:Colors.white,fontSize: 20),),
                ...
                child: Container(
                  child: Row(
                    ...
                    children: [
                      ...
                      Text("  ALGO. DESIGN-II",style: TextStyle(color:Colors.white,fontSize: 20),),
                    ],
                  ),
                  height: 50,
                  width: MediaQuery.of(context).size.width-50,
                ...
                child: Container(
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(" LINEAR ALGEBRA",style: TextStyle(color:Colors.white,fontSize: 20),),
                ...
                child: Container(
                  child: Row(
                    ...
                    children: [
                      ...
                      Text("  UNIVERSAL HUMAN VALUES",style: TextStyle(color:Colors.white,fontSize: 20),),
                    ],
                  ),
                  height: 50,
                  width: MediaQuery.of(context).size.width-50,
