...
class sevsem extends StatelessWidget {
  const sevsem({Key? key}) : super(key: key);
                ...
                child: Container(
                  child: Row(
                    ...
                    children: [
                      ...
                      Text("  INFORMATION RETRIEVAL",style: TextStyle(color:Colors.white,fontSize: 20),),
                    ],
                  ),
                  height: 50,
                ...
                child: Container(
                  child: Row(
                    ...
                    children: [
                      ...
                      Text("  DATA MINING",style: TextStyle(color:Colors.white,fontSize: 20),),
                ...
                child: Container(
                  child: Row(
                    ...
                    children: [
                      ...
                      Text("  CLOUD COMPUTING",style: TextStyle(color:Colors.white,fontSize: 20),),
                    ],
                  ),
                  height: 50,
                  width: MediaQuery.of(context).size.width-50,
                ...
                child: Container(
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(" DISTRIBUTED SYSTEMS",style: TextStyle(color:Colors.white,fontSize: 20),),
                ...
                child: Container(
                  child: Row(
                    ...
                    children: [
                      ...
                      Text("  IOT",style: TextStyle(color:Colors.white,fontSize: 20),),
                    ],
                  ),
                  height: 50,
                  width: MediaQuery.of(context).size.width-50,
                ...
                child: Container(
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(" ENV. STUDIES",style: TextStyle(color:Colors.white,fontSize: 20),),
