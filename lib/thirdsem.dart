                ...
                child: Container(
                  child: Row(
                    ...
                    children: [
                      ...
                      Text("  CS WORKSHOP-I",style: TextStyle(color:Colors.white,fontSize: 20),),
                    ],
                  ),
                  height: 50,
                ...
                child: Container(
                  child: Row(
                    ...
                    children: [
                      ...
                      Text("  DIGITAL LOGIC DESIGN",style: TextStyle(color:Colors.white,fontSize: 20),),
                ...
                child: Container(
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(" ALGO. DESIGN-I",style: TextStyle(color:Colors.white,fontSize: 20),),
                    ],
                  ),
                  height: 50,
                  width: MediaQuery.of(context).size.width-50,
                ...
                child: Container(
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(" PROBABILITY AND STATISTICS",style: TextStyle(color:Colors.white,fontSize: 20),),
                ...
                child: Container(
                  child: Row(
                    ...
                    children: [
                      ...
                      Text("  MACRO-ECONOMICS",style: TextStyle(color:Colors.white,fontSize: 20),),
                    ],
                  ),
                  height: 50,
                  width: MediaQuery.of(context).size.width-50,
