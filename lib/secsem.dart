...
class secsem extends StatelessWidget {
  const secsem({Key? key}) : super(key: key);
                ...
                child: Container(
                  child: Row(
                    ...
                    children: [
                      ...
                      Text("  DSA",style: TextStyle(color:Colors.white,fontSize: 20),),
                    ],
                  ),
                  height: 50,
                ...
                child: Container(
                  child: Row(
                    ...
                    children: [
                      ...
                      Text("  GRAPH THEORY",style: TextStyle(color:Colors.white,fontSize: 20),),
                ...
                child: Container(
                  child: Row(
                    ...
                    children: [
                      ...
                      Text("  CALCULLUS-II",style: TextStyle(color:Colors.white,fontSize: 20),),
                    ],
                  ),
                  height: 50,
                  width: MediaQuery.of(context).size.width-50,
                ...
                child: Container(
                  child: Row(
                    ...
                    children: [
                      ...
                      Text("  PHYSICS(ELECTROSTATICS)",style: TextStyle(color:Colors.white,fontSize: 20),),
                ...
                child: Container(
                  child: Row(
                    ...
                    children: [
                      ...
                      Text("  CRITICAL THINKING",style: TextStyle(color:Colors.white,fontSize: 20),),
                    ],
                  ),
                  height: 50,
                  width: MediaQuery.of(context).size.width-50,
