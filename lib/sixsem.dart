...
class sixsem extends StatelessWidget {
                ...
                child: Container(
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(" COMP. NETWORKING WORKSHOP",style: TextStyle(color:Colors.white,fontSize: 20),),
                    ],
                  ),
                  height: 50,
                ...
                child: Container(
                  child: Row(
                    ...
                    children: [
                      ...
                      Text("  INTRO. TO DATABASE",style: TextStyle(color:Colors.white,fontSize: 20),),
                ...
                child: Container(
                  child: Row(
                    ...
                    children: [
                      ...
                      Text("  CRYPTOGRAPHY &NET. SECURITY",style: TextStyle(color:Colors.white,fontSize: 20),),
                    ],
                  ),
                  height: 50,
                  width: MediaQuery.of(context).size.width-50,
                ...
                child: Container(
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(" DATA SCIENCE USING PYTHON",style: TextStyle(color:Colors.white,fontSize: 20),),
                ...
                child: Container(
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(" COMPILER DESIGNING",style: TextStyle(color:Colors.white,fontSize: 20),),
                    ],
                  ),
                  height: 50,
                  width: MediaQuery.of(context).size.width-50,
